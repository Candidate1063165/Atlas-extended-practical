...
void main_ZBosonAnalysis(int proof = 0, int option= 0)
{
  ...
  if (option==11 || option==0){
    ...
    chain_dataA->Process("ZBosonAnalysis.C+","dataA");
  }
  ...
  if (option==12 || option==0){
    ...
    chain_dataB->Process("ZBosonAnalysis.C+","dataB");
  }
  ...
  if (option==13 || option==0){
    ...
    chain_dataC->Process("ZBosonAnalysis.C+","dataC");
  }
  ...
  if (option==14 || option==0){
    ...
    chain_dataD->Process("ZBosonAnalysis.C+","dataD");
  }
  ...
  if (option==2 || option==0)   {
    ...
    chain_ZqqZll->Process("ZBosonAnalysis.C+","ZqqZll");
    ...
    chain_WqqZll->Process("ZBosonAnalysis.C+","WqqZll");
    ...
    chain_WpqqWmlv->Process("ZBosonAnalysis.C+","WpqqWmlv");
    ...
    chain_WplvWmqq->Process("ZBosonAnalysis.C+","WplvWmqq");
    ...
    chain_WlvZqq->Process("ZBosonAnalysis.C+","WlvZqq");
  }
